...
@interface LocationShareStartCell ()
@property (nonatomic, strong)UIImageView *bubbleBackgroundView;
@property (nonatomic, strong)UILabel *textLabel;
@property (nonatomic, strong)UIImageView *locationView;
@end

#define RC_LOCATION_SHARE_CELL_LOCATION_ICON_WIDTH 10
#define RC_LOCATION_SHARE_CELL_LOCATION_ICON_HEIGHT 15

@implementation LocationShareStartCell
...
//    }
    ...
    CGFloat __bubbleWidth = __labelSize.width + 15 + RC_LOCATION_SHARE_CELL_LOCATION_ICON_WIDTH < 50 ? 50 : (__labelSize.width + 15 + RC_LOCATION_SHARE_CELL_LOCATION_ICON_WIDTH);
    ...
    if (MessageDirection_RECEIVE == self.messageDirection) {
        ...
        self.locationView.frame =CGRectMake(15, 10, RC_LOCATION_SHARE_CELL_LOCATION_ICON_WIDTH, RC_LOCATION_SHARE_CELL_LOCATION_ICON_HEIGHT);
        ...
        self.textLabel.frame = CGRectMake(RC_LOCATION_SHARE_CELL_LOCATION_ICON_WIDTH, 5, __labelSize.width, __labelSize.height);
        
        self.locationView.frame = CGRectMake(10+__labelSize.width + 3, 10, RC_LOCATION_SHARE_CELL_LOCATION_ICON_WIDTH, RC_LOCATION_SHARE_CELL_LOCATION_ICON_HEIGHT);
